...
const panelHTML = `
    ...
    <div class="auto-bet">
        ...
        <div class="data">
            <p>The last color drawn: <span class="auto-bet__last-color">${
              colors[balls.lastChild.children[0].classList[0]]
            }</span></p>
            <p>Max bet: <span class="auto-bet__current-max-bet">Blank</span></p>
            <p>Current bet: <span class="auto-bet__current-bet">Blank</span></p>
        </div>
...
const changeState = (newState) => {
  ...
  currentBetPanel.innerText = bet || "Blank";
  maxBetPanel.innerHTML = maxBet || "Blank";
